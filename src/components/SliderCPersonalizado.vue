<template lang="pug">
.linea-tiempo-c.position-relative
    ...
    .col-8.col-sm.px-0
      .row.mx-0.flex-nowrap.linea-tiempo-c__header__items
        ScrollHorizontal(
          ...
          .col-6.col-sm-4.px-0.py-3.linea-tiempo-c__header__item(
            ...
            .indicador__container(v-if="mostrarIndicador && index === 1" style="top: .4rem; left: -.2rem")
