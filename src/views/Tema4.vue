...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    img(src="@/assets/curso/temas/tema4/img-2.png").mb-5

    p.mb-5 Adicionalmente puedes ver otras de las aplicaciones de la fotografía en redes sociales en el siguiente video:

    figure.mb-5.video1
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/GG4_FH8Z5EE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
</template>
